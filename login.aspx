            ...
            <tr>
                ...
                <tr>
                    <td colspan="2" align="left">
                        ...
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List" HeaderText="<b>WARNING:</b>" ForeColor="Red" />
                        <div id="divMsg" runat="server" style="color:Red" visible="false"><b>WARNING:</b><br /><b>Username</b> or <b>Password</b> is wrong.</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="left">
