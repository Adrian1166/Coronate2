<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="uscitaStudio.aspx.cs" Inherits="ssl_uscitaStudio" %>
...
<asp:Panel id="Page1ViewPanel"
   ...
   <div style="margin-top:0px">
    ...
    <asp:SqlDataSource ID="SqlUscitaStudio" runat="server" ConnectionString="<%$ ConnectionStrings:CoronateConnectionString %>"
        ProviderName="<%$ ConnectionStrings:CoronateConnectionString.ProviderName %>" OnSelected="SqlUscitaStudio_OnSelected" SelectCommand=""
        InsertCommand="INSERT INTO TBUscitaStudio (IdCentro, IdPaziente, IdTipVis, StudioCompletato, IdMotivoUscita, AltroMotivo,SemID)
                        Values (?IdCentro, ?IdPaziente, 1, ?StudioCompletato, ?IdMotivoUscita, ?AltroMotivo,1)"
        UpdateCommand="UPDATE TBUscitaStudio SET StudioCompletato=?StudioCompletato, IdMotivoUscita=?IdMotivoUscita, AltroMotivo=?AltroMotivo
                    WHERE IdUscitaStudio=?IdUscitaStudio">
            <InsertParameters>
            ...
            <UpdateParameters>
                ...
                <asp:Parameter Name="IdMotivoUscita" />
                <asp:Parameter Name="AltroMotivo" />
                <asp:Parameter Name="IdUscitaStudio" />
            </UpdateParameters>
        </asp:SqlDataSource> 
    <asp:FormView ID="frwUscitaStudio" style="margin-top:4px" CellSpacing="1" CellPadding="0" BorderWidth="0" runat="server" Width="99%" HorizontalAlign="Center" DataSourceID="SqlUscitaStudio" DefaultMode="Insert" 
        onItemInserted="frwUscitaStudio_ItemInserted" onItemUpdated="frwUscitaStudio_ItemUpdated">
        <EditItemTemplate>
            ...
            <tr>
                ...
                <td align="left" class="TD1">
                    ...
                    <asp:HiddenField ID="IdUscitaStudio" runat="server" Value='<%# Bind("IdUscitaStudio")%>' />
           ...
           <tr>
            ...
            <tr><td align="left"  colspan="2">
                <asp:RequiredFieldValidator ControlToValidate="StudioCompletato" ID="RequiredFieldValidator1" runat="server" ErrorMessage="The field <b>Did the patient complete the study? </b> is required." Display="None"></asp:RequiredFieldValidator>
...
<script language="javascript">
    ...
    {
        var StudioCompletato = document.getElementById("frwUscitaStudio_StudioCompletato_1");

        var IdMotivoUscita = document.getElementById("frwUscitaStudio_IdMotivoUscita");
    ...
    function abilitareAltro() {
        var IdMotivoUscita = document.getElementById("frwUscitaStudio_IdMotivoUscita");
        var txtAltroSpec = document.getElementById("frwUscitaStudio_AltroMotivo");
