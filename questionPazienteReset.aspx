<div id="divOpacityQuestionPazienteReset" class="div_trasparenza" visible="false" style="visibility:hidden">
<iframe style="Z-INDEX: 101;WIDTH: 100%; HEIGHT: 100%" align="center" marginheight="0" hspace="0" marginwidth="0" vspace="0" scrolling="no" frameborder="0" name="trans" id="trans" src="../nera.htm"></iframe>
 ...
 <div id="divQuestionPazienteReset" runat="server" 
    ...
    visible="false">
    <div class="titoloPag" style="font-size:16px"><b>CORONATE RESET FASE 2</b></div><div style="position:absolute; right:7px;top:3px"><asp:ImageButton ID="imgChiudiBoxReset" runat="server" CausesValidation="false" ImageUrl="../images/icon_close.gif" OnClick="CloseQuestionPazienteReset_Click" /></div>
    <table align="center" width="100%">
        ...
        <tr>
            ...
            <td align="left" class="TD1"><asp:label runat="server" id="lblNumPazR" width="100px" ForeColor="black" Font-Size="14px"></asp:label></td>
        </tr>
        <tr><td colspan="2">
            <table width="100%"><tr><td>
            <asp:FormView ID="frwQuestionPazienteReset" CellSpacing="1" CellPadding="0" BorderWidth="0" runat="server" Width="99%" HorizontalAlign="Center" DataSourceID="SqlQuestionPazienteReset" DefaultMode="Edit" 
       >
        <EditItemTemplate>
        ...
        <tr>
            <td align="center" colspan="2">
                <br />
                <asp:Button ID="CloseQuestionPazienteReset" runat="server" Text="Close" CausesValidation="false" OnClick="CloseQuestionPazienteReset_Click" Width="75px" CssClass="button" />
            
        </td></tr></table>
        <asp:SqlDataSource ID="SqlQuestionPazienteReset" runat="server" ConnectionString="<%$ ConnectionStrings:CoronateConnectionString %>"
        ProviderName="<%$ ConnectionStrings:CoronateConnectionString.ProviderName %>" SelectCommand=""></asp:SqlDataSource>
</div>
<script type="text/javascript">
    show_overDiv("<%=Session["deleteRecQuestionPazienteReset"]%>","divOpacityQuestionPazienteReset");
</script>